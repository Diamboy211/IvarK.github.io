...
function softReset(bulk) {
  ...
  player = {
      ...
      fifthCost: new Decimal(1e5),
      sixthCost: new Decimal(1e6),
      seventhCost: new Decimal(1e8),
      eightCost: new Decimal(1e10),
    ...
    newsArray: player.newsArray,
      ...
      costMultipliers: [new Decimal(1e2), new Decimal(1e3), new Decimal(1e4), new Decimal(1e5), new Decimal(1e6), new Decimal(1e8), new Decimal(1e10), new Decimal(1e12)],
